...
},{"gsap/dist/gsap":"node_modules/gsap/dist/gsap.js","gsap":"node_modules/gsap/index.js","scrollmagic":"node_modules/scrollmagic/scrollmagic/uncompressed/ScrollMagic.js"}],"assets/js/main.js":[function(require,module,exports) {
"use strict";
...
_gsap.default.from(".hero-text", {
  x: -100,
  duration: 1,
  opacity: 0
});
_gsap.default.from(".hero-image", {
  x: 100,
  duration: 1,
  opacity: 0
});
...
new _scrollmagic.default.Scene({
  ...
  triggerHook: 0.5
}).setTween(_gsap.default.from(".about-content", {
  x: -100,
  opacity: 0,
  duration: 1
})).addTo(controller);
